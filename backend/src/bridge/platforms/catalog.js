...
export const platformCatalog = {
  ...
  twitch: { id: "twitch", name: "Twitch", short: "Tw", color: "#9146ff", accountType: "Channel chat", formats: ["text"], captionLimit: 500 },
  kick: { id: "kick", name: "Kick", short: "K", color: "#238b00", accountType: "Channel chat", formats: ["text"], captionLimit: 500 },
  telegram: { id: "telegram", name: "Telegram", short: "Tg", color: "#5aa9e6", accountType: "Channel or group", formats: ["text", "image", "video", "carousel", "document"], captionLimit: 4096, maxImages: 10, mixedCarousel: true, imageMaxBytes: 10 * 1024 ** 2, videoMaxBytes: 50 * 1024 ** 2, documentMaxBytes: 50 * 1024 ** 2 },
