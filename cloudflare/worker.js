...
export class PodcastClipperBackend extends Container {
  ...
  envVars = definedEnv({
    ...
    // Prefer the current Meta app while retaining the previous credentials in
    // Cloudflare under their original names for rollback or later recovery.
    INSTAGRAM_CLIENT_ID: env.INSTAGRAM_CLIENT_ID_V2 || env.INSTAGRAM_CLIENT_ID,
    INSTAGRAM_CLIENT_SECRET: env.INSTAGRAM_CLIENT_SECRET_V2 || env.INSTAGRAM_CLIENT_SECRET,
    FACEBOOK_CLIENT_ID: env.FACEBOOK_CLIENT_ID_V2 || env.FACEBOOK_CLIENT_ID,
    FACEBOOK_CLIENT_SECRET: env.FACEBOOK_CLIENT_SECRET_V2 || env.FACEBOOK_CLIENT_SECRET,
    FACEBOOK_LOGIN_CONFIG_ID: env.FACEBOOK_LOGIN_CONFIG_ID,
    ...
    LINKEDIN_VERSION: env.LINKEDIN_VERSION,
