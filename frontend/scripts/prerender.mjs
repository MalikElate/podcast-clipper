...
const pages = [
  { path: "", kind: null, title: "Meadow — Publish everywhere from your AI agent", description: "Give your AI agent one secure Meadow API key to preview, schedule, publish, and track posts across Instagram, TikTok, YouTube, Facebook, X, LinkedIn, Pinterest, Threads, Bluesky, and Google Business." },
