...
const pages = [
  { path: "tiktok-roast", kind: "tiktok-roast", title: "Niche or Not — Free TikTok Caption Review · Meadow", description: "Review public TikTok captions, get practical fixes, then use Meadow to schedule and cross-post what you create next." },
