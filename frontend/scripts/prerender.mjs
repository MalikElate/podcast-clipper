...
const pages = [
  { path: "", kind: null, title: "Meadow — Publish across every social media", description: "Create, schedule, publish, and track posts across Instagram, TikTok, YouTube, Facebook, X, LinkedIn, Pinterest, Threads, Bluesky, and Google Business." },
