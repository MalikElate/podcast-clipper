...
assert.ok(landingHtml.indexOf('class="home-hero-platforms"') < landingHtml.indexOf('Make sure you just show up for every audience'), "Homepage platform logos must appear above the headline");
assert.ok(landingHtml.indexOf('Make sure you just show up for every audience') < landingHtml.indexOf('class="hero-demo"'), "Homepage demo must appear below the hero copy");
