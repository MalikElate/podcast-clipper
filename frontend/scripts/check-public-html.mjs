...
for (const [path, heading] of [["", "Publish across every social account"], ["terms/", "Terms of Service"], ["terms-of-service/", "Terms of Service"], ["privacy/", "Privacy Policy"], ["privacy-policy/", "Privacy Policy"]]) {
