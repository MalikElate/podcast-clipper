...
assert.ok(roastHtml.includes("Let Jeff tell you whether your TikTok is niche or not. Find out if you’re a normie."), "tiktok-roast/index.html missing requested subheader");
