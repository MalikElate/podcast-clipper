      ...
      <main>
          ...
          <div className="platform-use-case-hero-grid">
            <div className="platform-use-case-copy">
              ...
              <div className="platform-use-case-actions">
                <button className="btn-primary landing-cta" onClick={onGetStarted}>Start posting <ArrowIcon /></button>
        ...
        <section className="landing-cta-section platform-use-case-cta">
          <div className="landing-cta-content">
            <h2>Ready to plan your {platform.name} publishing?</h2>
            <p>Bring your {platform.name} schedule into Meadow and manage publishing alongside your other social channels.</p>
            <div className="landing-cta-actions">
              <button className="landing-cta-primary" onClick={onGetStarted}>Start posting <ArrowIcon /></button>
      ...
      <footer className="landing-footer platform-use-case-footer">
        <div className="footer-main">
          ...
          <div className="footer-links">
            <div><h2>Platform guides</h2>{PLATFORM_USE_CASES.map((item) => <a href={`/${item.slug}`} key={item.id}>{item.name} publishing</a>)}</div>
