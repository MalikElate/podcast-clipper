...
export const PLATFORM_PRIVACY = [
  ...
  },
  {
    ...
    details: [
      { label: "Data Meadow accesses", text: "TikTok open ID, display name, username or nickname and avatar; available visibility and interaction options and maximum video duration; the videos or photos, captions, delivery method, schedule, visibility, interaction, commercial-content and AI-content choices you submit; upload and publish IDs, status, links and rejection reasons; and public video IDs, creation dates and available views, likes, comments and shares." },
      { label: "How Meadow uses it", text: "To show the correct account and publishing choices, publish selected content directly with video.publish or upload it to your TikTok inbox with video.upload, track delivery and display available public-video performance. Photo inbox uploads can include your title and caption; video inbox uploads transfer the video, and you add its caption in TikTok. TikTok authorization-removal events let Meadow stop publishing and remove the affected connection data." },
      { label: "Finishing in TikTok", text: "For inbox delivery, open TikTok’s notification to finish editing and publish manually. Scheduling this delivery schedules the transfer only. Meadow records the completed transfer as awaiting publication, not as a confirmed published post. This does not access drafts saved locally on your phone. Unfinished uploads and private posts do not provide public-video analytics. Existing connections must be authorized again to grant video.upload." },
      { label: "Retention and removal", text: activeConnectionRetention },
    ],
