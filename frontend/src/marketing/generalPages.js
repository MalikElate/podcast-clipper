...
const SHARED_FAQS = [
  { q: "Does Meadow support Twitch and Kick?", a: "Twitch and Kick chat publishing are coming soon. The integrations are built for scheduled text messages, replies, and follow-up threads; Twitch also supports colored announcements. Production activation is still pending. These integrations do not upload videos, broadcast live streams, or provide chat engagement analytics." },
