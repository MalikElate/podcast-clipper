...
export default function ApiKeys({ timeZone = "UTC" }) {
  ...
  return <>
    <div className="bridge-intro-row"><p>Create keys for Bridge REST API and CLI clients. Every key has the same access as your workspace account.</p><button className="bridge-button" onClick={() => { setError(""); setCreating(true); }}><Icon name="plus" size={17}/> Create API key</button></div>
