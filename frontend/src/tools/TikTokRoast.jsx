  ...
  return <div className="landing tiktok-roast-page">
    ...
    <main>
      <section className="roast-hero" aria-labelledby="roast-title">
        <div className="roast-intro"><a className="roast-powered-badge" href="https://typesafe.ai/blog/introducing-system-one-models-and-jev" target="_blank" rel="noreferrer">Powered by Jev</a><h1 id="roast-title">TikTok <span>Niche or Not</span></h1><p>Find out if you’re making niche content or just normie posting.</p></div>
