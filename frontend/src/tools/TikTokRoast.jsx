  ...
  return <div className="tiktok-roast-page">
    ...
    <main>
      <section className="roast-hero" aria-labelledby="roast-title">
        <div className="roast-intro"><h1 id="roast-title">Roast my <span>TikTok.</span></h1><p>Your profile. Your posts. A running roast as you scroll. Pull up your TikTok and see which captions can take the heat.</p></div>
      ...
      {result && <section className="roast-results" ref={output} tabIndex="-1" aria-labelledby="roast-result-title">
        ...
        <div className="roast-result-top"><div><span className="roast-eyebrow">THE FINAL VERDICT</span><h2>Your captions, collectively roasted.</h2><p>{result.posts.length} public posts sampled · {new Date(result.sampledAt).toLocaleDateString()} · {result.counts.strong} strong · {result.counts.thin} thin · {result.counts.filler} filler</p></div></div>
      ...
      <section className="roast-explainer" aria-labelledby="roast-how-title"><div><span className="roast-eyebrow">HOW THE HEAT WORKS</span><h2 id="roast-how-title">A roast with receipts.</h2><p>Specific feedback you can use. No mystery number. No follower-count flexing.</p></div><div className="roast-steps"><article><span>01</span><h3>Drop a public handle</h3><p>Your profile, bio, and recent public posts appear in a scrollable feed.</p></article><article><span>02</span><h3>Find the weak spots</h3><p>Scroll post by post, or play the walkthrough. Each caption gets its own roast and a practical fix.</p></article><article><span>03</span><h3>Make the next one better</h3><p>Take the fixes, save your roast card, and put a stronger caption out into the world.</p></article></div></section>
