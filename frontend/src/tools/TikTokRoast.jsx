  ...
  return <div className="tiktok-roast-page">
    ...
    <main>
      <section className="roast-hero" aria-labelledby="roast-title">
        <div className="roast-intro"><h1 id="roast-title">Roast my <span>TikTok.</span></h1><p>Your captions are in the hot seat. Get a playful roast, an honest score, and a better idea for your next post.</p></div>
