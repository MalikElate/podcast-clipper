  ...
  return <div className="tiktok-roast-page">
    ...
    <main>
      <section className="roast-hero" aria-labelledby="roast-title">
        <div className="roast-intro"><h1 id="roast-title">TikTok <span>Hot or Not.</span></h1><p>See which captions are hot, which need work, then use Meadow to schedule and cross-post what you create next.</p></div>
